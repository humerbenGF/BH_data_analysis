...
# import toroidal current data from aurora
#################################################################
def load_data_tor_current_multishot(shot_list):
    if os.path.isfile("plasma_data_and_parameters/toroidal_current/toroidal_current.json"):
        multishot_current = load_data.load_json_file("plasma_data_and_parameters/toroidal_current/toroidal_current.json")
    else:
        multishot_current = {}
    ...
    for shot in shot_list:
        ...
        save_data.save_json("plasma_data_and_parameters/toroidal_current/toroidal_current.json", multishot_current)
...
def load_data_pol_current_singleshot(shot_number):
    q_options = {   'experiment':'pi3b',
                    'manifest': 'default',
                    'shot': shot_number,
                    'layers':'reconstruction/Ipl_mean',
                    'errors':'reconstruction/Ipl_sigma',
                    'nodisplay': True}
